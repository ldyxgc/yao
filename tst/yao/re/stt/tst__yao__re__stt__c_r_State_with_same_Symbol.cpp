...
int main() {
  ...
  YAO_CHECK(
      (c_r_State_with_same_Symbol<ErasedState<char>, ErasedState<long>>) ==
      false);
  YAO_CHECK(
      (c_r_State_with_same_Symbol<ErasedState<char>, SymbolState<long>>) ==
      false);

  YAO_CHECK(
      (c_r_State_with_same_Symbol<ErasedState<char>, ErasedState<char>>) ==
      true);
  YAO_CHECK(
      (c_r_State_with_same_Symbol<ErasedState<char>, SymbolState<char>>) ==
      true);
