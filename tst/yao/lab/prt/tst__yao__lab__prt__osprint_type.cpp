...
int main() {
  ...
  { // ns = false, tp = false
    auto test = [](auto val, auto out) {
      ...
      yao::lab::prt::osprint_type<decltype(val)>(oss);
      return oss.str() == out;
    };
  ...
  { // ns = true, tp = false
    auto test = [](auto val, auto out) {
      std::ostringstream oss;
      yao::lab::prt::osprint_type<decltype(val), true>(oss);
      return oss.str() == out;
    };
  ...
  { // ns = false, tp = true
    auto test = [](auto val, auto out) {
      std::ostringstream oss;
      yao::lab::prt::osprint_type<decltype(val), false, true>(oss);
      return oss.str() == out;
    };
  ...
  { // ns = true, tp = true
    auto test = [](auto val, auto out) {
      std::ostringstream oss;
      yao::lab::prt::osprint_type<decltype(val), true, true>(oss);
      return oss.str() == out;
    };
