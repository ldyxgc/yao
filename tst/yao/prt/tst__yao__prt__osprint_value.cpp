...
struct Int8 {
  ...
  template <bool ns, bool tp> void osprint_value(std::ostream &os) const {
    yao::prt::osprint_type<Int8, ns, tp>(os);
    os << ": {_i8:";
    yao::prt::osprint_value<ns, tp>(os, _i8);
    os << '}';
  }
};
...
struct Uint8 {
  ...
  void osprint_value(std::ostream &os, bool ns, bool tp) const {
    ns ? (tp ? yao::prt::osprint_type<Uint8, true, true>(os)
             : yao::prt::osprint_type<Uint8, true>(os))
       : (tp ? yao::prt::osprint_type<Uint8, false, true>(os)
             : yao::prt::osprint_type<Uint8>(os));
    os << ": {_u8:";
    ns ? (tp ? yao::prt::osprint_value<true, true>(os, _u8)
             : yao::prt::osprint_value<true>(os, _u8))
       : (tp ? yao::prt::osprint_value<false, true>(os, _u8)
             : yao::prt::osprint_value<>(os, _u8));
    os << '}';
  }
};
...
int main() {
  ...
  { // ns = true, tp = false
    auto test = [](auto val, auto out) {
      std::ostringstream oss;
      yao::prt::osprint_value<true>(oss, val);
      return oss.str() == out;
    };
  ...
  { // ns = false, tp = true
    auto test = [](auto val, auto out) {
      std::ostringstream oss;
      yao::prt::osprint_value<false, true>(oss, val);
      return oss.str() == out;
    };
  ...
  { // ns = true, tp = true
    auto test = [](auto val, auto out) {
      std::ostringstream oss;
      yao::prt::osprint_value<true, true>(oss, val);
      return oss.str() == out;
    };
