#ifndef __YAO__RE__STT__C_R_NO_CVREF_STATE_WITH_SAME_SYMBOL__HPP__
#define __YAO__RE__STT__C_R_NO_CVREF_STATE_WITH_SAME_SYMBOL__HPP__
...
concept c_r_no_cvref_State_with_same_Symbol =
